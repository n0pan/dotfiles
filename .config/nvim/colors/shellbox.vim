...
let s:gb.dark0_hard  = ['#041b1e', 234]     " 29-32-33
let s:gb.dark0       = ['#051e22', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#1d3438', 236]     " 50-48-47
let s:gb.dark1       = ['#1d3438', 237]     " 60-56-54
let s:gb.dark2       = ['#364a4e', 239]     " 80-73-69
let s:gb.dark3       = ['#506164', 241]     " 102-92-84
let s:gb.dark4       = ['#69787a', 243]     " 124-111-100
let s:gb.dark4_256   = ['#828e90', 243]     " 124-111-100

let s:gb.gray_245    = ['#4a5c5f', 245]     " 146-131-116
let s:gb.gray_244    = ['#4a5c5f', 244]     " 146-131-116
